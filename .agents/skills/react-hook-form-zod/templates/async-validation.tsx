  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-md space-y-4">
      ...
      <div>
        ...
        />
        {isValidating && (
          <span className="mt-1 block text-sm text-blue-600">Checking availability...</span>
        )}
        {errors.username && (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-md space-y-4">
      ...
      <div>
        ...
        {!errors.username && username.length >= 3 && !isCheckingUsername && (
          <span className="mt-1 block text-sm text-green-600">Username is available ✓</span>
        )}
      </div>
      ...
      <div>
        ...
        {!errors.email && email && !isCheckingEmail && (
          <span className="mt-1 block text-sm text-green-600">Email is available ✓</span>
        )}
      </div>
